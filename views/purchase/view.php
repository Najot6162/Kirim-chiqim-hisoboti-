...
<div class="order-product-form">
    ...
    <div class="row">
        <div class="col-2">
            <h6> Prixod Raqami <?= $purchase_date->number ?></h6>
        </div>
        <div class="col-2">
            <h6> Prixod Vaqti : <?= $purchase_date->date ?></h6>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-2">    <?= $form->field($model, 'price')->textInput(['maxlength' => true]) ?></div>
        <div class="col-2">
            <h6> </h6>
